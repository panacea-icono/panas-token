...
class AIService:
    ...
    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None):
        ...
        if self.ai_provider == "ollama" and self.ollama_enabled:
            ...
            if not self.api_key:
                raise ValueError("Se requiere una clave API de OpenAI. Establece OPENAI_API_KEY en tu .env")
    ...
    async def _call_ollama(self, messages: list, max_tokens: int = 500, temperature: float = 0.7) -> str:
    ...
    async def _call_openai(self, messages: list, max_tokens: int = 500, temperature: float = 0.7) -> str:
    ...
    async def generate_smart_contract_description(self, contract_name: str, functionality: str) -> str:
        """
